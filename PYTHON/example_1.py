...
poincare_sthetaphi_order2 = np.genfromtxt(path_script2RUN + '/' + 'poincare_plot_vpar_0_sthetaphi_order2.dat')
poincare_sthetaphi_order3 = np.genfromtxt(path_script2RUN + '/' + 'poincare_plot_vpar_0_sthetaphi_order3.dat')
poincare_sthetaphi_order4 = np.genfromtxt(path_script2RUN + '/' + 'poincare_plot_vpar_0_sthetaphi_order4.dat')
poincare_sthetaphi_rk4 = np.genfromtxt(path_script2RUN + '/' + 'poincare_plot_vpar_0_sthetaphi_rk4.dat')

# Load Poincaré cut data in cylindrical coordinates (R,\varphi,Z)
poincare_rphiz_order2 = np.genfromtxt(path_script2RUN + '/' + 'poincare_plot_vpar_0_rphiz_order2.dat')
poincare_rphiz_order3 = np.genfromtxt(path_script2RUN + '/' + 'poincare_plot_vpar_0_rphiz_order3.dat')
poincare_rphiz_order4 = np.genfromtxt(path_script2RUN + '/' + 'poincare_plot_vpar_0_rphiz_order4.dat')
poincare_rphiz_rk4 = np.genfromtxt(path_script2RUN + '/' + 'poincare_plot_vpar_0_rphiz_rk4.dat')

# Load parallel adiabatic invariant data 
J_par_order2 = np.genfromtxt(path_script2RUN + '/' + 'J_par_order2.dat')
J_par_order3 = np.genfromtxt(path_script2RUN + '/' + 'J_par_order3.dat')
J_par_order4 = np.genfromtxt(path_script2RUN + '/' + 'J_par_order4.dat')
J_par_rk4 = np.genfromtxt(path_script2RUN + '/' + 'J_par_rk4.dat')

# Normalize parallel adiabatic invariant to the value at t = 0
J_par_order2[:,1] = J_par_order2[:,1] / J_par_order2[0,1]
J_par_order3[:,1] = J_par_order3[:,1] / J_par_order3[0,1] 
J_par_order4[:,1] = J_par_order4[:,1] / J_par_order4[0,1] 
J_par_rk4[:,1] = J_par_rk4[:,1] / J_par_rk4[0,1]  
